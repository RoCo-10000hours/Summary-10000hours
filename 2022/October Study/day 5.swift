...
/*-----------------------------------------*/
여기위에 까지가 강사님이 생각하는 너 나 우리 이해가능한
건.강.한 축약의 한계치
/*-----------------------------------------*/
...
강사님의 조언 : 우리가하는 지금 하는 문법공부들은 마치 토익시험을 준비하듯 그런 목적이아니다
            결국엔 앱을 만들기 위한 목표의 한 과정이고 스위프트를 혼자서도 이해 가능한 
            수준이 되게 하려는 의도일뿐이다.. 만약 기초문법을 강의 한다면 세달은 가능하지만 
            그러지 않는 이유..... 
            허생이 집에서 공부만하고 과거시험을 보지않자 부모가 나무랬더니
            그가 했던말이 .. 아직 준비가 덜 됬습니다....우리는 허생이아니다...
            준비를 다하고 가면 이미 많은것들이 바뀌었을수도 있으니 일단 나아가기를.